...
const crearPreferencia = async (req, res) => {
    try {
        ...
        try {
            let pedido;
            const existente = await PedidoOnline.findOne({
                where: {
            ...
            if (existente) {
                await existente.update({
                    ...
                    cliente_nombre: existente.cliente_nombre || cliente_nombre || null,
                    cliente_telefono: existente.cliente_telefono || cliente_telefono || null,
                    cliente_direccion: existente.cliente_direccion || cliente_direccion || null,
                });
                pedido = existente;
                console.log('♻️ Pedido pendiente reutilizado:', externalRef);
            } else {
